        ...
        <div className="bg-white dark:bg-[#111827] border border-brand-pale dark:border-brand-dark/20 rounded-2xl overflow-hidden shadow-xl shadow-brand-pale/5">
          {loading ? (
            <div className="flex flex-col justify-center items-center py-16 space-y-3">
              ...
              <span className="text-sm text-gray-400">Loading your notifications...</span>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-20 text-gray-400 dark:text-gray-500 space-y-4">
              ...
              <p className="text-xs text-gray-500 max-w-xs text-center">No matching alerts were discovered under this filter.</p>
            </div>
          ) : (
                ...
                >
                  ...
                  <div className="flex-1 space-y-1">
                    <div className="flex justify-between items-start space-x-2">
                      <p className={`text-sm ${
                        notif.isRead ? 'text-gray-600 dark:text-gray-300' : 'text-gray-900 dark:text-white font-semibold'
                      }`}>
                        {notif.message}
                      </p>
