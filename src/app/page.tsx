...
export default function CatalogPage() {
  ...
  }, [user, page, selectedCategoryId, status]);
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {devices.map((device, index) => (
                  ...
                  >
                    ...
                    {/* Bottom: Price / Action */}
                    <div className="p-4 bg-gray-50/50 dark:bg-gray-900/30 border-t border-brand-pale/35 dark:border-brand-dark/20 flex items-center justify-between">
                      ...
                      <span className="text-xxs text-brand-blue font-bold group-hover:underline flex items-center">
                        <span>Details</span>
