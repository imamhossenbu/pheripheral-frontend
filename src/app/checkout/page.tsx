    ...
    <div className="min-h-screen flex flex-col bg-brand-pale/5 dark:bg-[#080d19]">
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Submit contact details and start payment for the selected devices.
        </p>
        ...
        {!user ? (
          <div className="mt-6 rounded-2xl border border-brand-pale dark:border-brand-dark/20 bg-white dark:bg-[#111827] p-12 text-center">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Devices can be viewed publicly, but orders and payments use your
              secured backend API.
            </p>
            <Link
              href="/login"
              className="mt-5 inline-flex rounded-xl bg-brand-blue px-5 py-3 text-sm font-bold text-white hover:bg-brand-dark"
            >
              Sign In
            </Link>
          </div>
          ...
          <form
            ...
            className="mt-6 grid lg:grid-cols-[1fr_360px] gap-6"
          >
            <section className="rounded-2xl border border-brand-pale dark:border-brand-dark/20 bg-white dark:bg-[#111827] p-6 space-y-5">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    readOnly
                    value="SSLCommerz"
                    className="w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 px-3 py-3 text-sm outline-none"
                  />
                </div>
                <div>
                  <label className="block text-xs font-bold text-gray-500 mb-1.5">
              ...
              <div>
                ...
                <textarea
                  name="notes"
                  rows={4}
                  placeholder="Delivery location, cost center, or approval notes..."
              ...
              <div className="rounded-xl border border-brand-pale/70 dark:border-brand-dark/20 bg-brand-pale/10 dark:bg-gray-900/30 p-4 flex gap-3 text-xs text-gray-500 dark:text-gray-400">
                ...
                <p>
                  Checkout creates an order with{" "}
                  <span className="font-mono">/orders</span>, then starts the
                  secured SSLCommerz session with{" "}
            ...
            <aside className="rounded-2xl border border-brand-pale dark:border-brand-dark/20 bg-white dark:bg-[#111827] p-5 h-fit">
              ...
              <div className="mt-5 space-y-3 border-t border-gray-100 dark:border-gray-800 pt-4 text-sm">
                ...
                <div className="flex justify-between text-base font-extrabold text-brand-dark dark:text-white">
                  <span>Total</span>
              ...
              <button
                disabled={loading}
                className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-brand-blue px-4 py-3 text-sm font-bold text-white hover:bg-brand-dark transition-colors disabled:opacity-60"
              >
                {loading ? (
