...
import {
  LayoutDashboard, Monitor, FolderTree, Users, History,
  Lock, Loader2, ClipboardList, CreditCard, PackageSearch,
  CalendarDays, Star, AlertCircle, Bell, LogOut, UserCircle,
  ChevronDown, Menu, X,
} from 'lucide-react';
...
const menuItems = [
  ...
  },
  {
    ...
    items: [
      { name: 'Borrow Requests', href: '/admin/borrow-requests', icon: PackageSearch },
  ...
  return (
    <header className="topbar justify-between px-4 lg:px-6">
      <div className="flex items-center gap-3">
        ...
        <button onClick={onMenuToggle} className="btn btn-icon btn-sm lg:hidden">
